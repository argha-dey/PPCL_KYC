...
public class AwarnessArticleActivity extends BaseActivity {
    ...
    private void setLinkToWebView(ArrayList<AwarnessLinkDo> awarnessLinkDos) {
        webView.loadUrl(awarnessLinkDos.get(0).getLink());
    }
}
