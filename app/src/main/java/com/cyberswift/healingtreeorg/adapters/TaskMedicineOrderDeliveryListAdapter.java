...
import com.cyberswift.healingtreeorg.homeCareAttendanceModuleActivity.MedicineDeliveryActivity;
...
public class TaskMedicineOrderDeliveryListAdapter extends RecyclerView.Adapter<TaskMedicineOrderDeliveryListAdapter.ViewHolder> {
    private Context context;
    private ArrayList<MedicineDeliveryTaskList> taskLists;
    private Prefs mPrefs;

    public TaskMedicineOrderDeliveryListAdapter(Context context, ArrayList<MedicineDeliveryTaskList> taskLists) {
