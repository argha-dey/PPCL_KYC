...
import com.cyberswift.healingtreeorg.document_download_manager.PdfDownloadManagerForHelloHealth;
...
import com.cyberswift.healingtreeorg.model.PackageModel;
...
public class HelloHealthActivity extends BaseActivity  {
    ...
    private void checkFileReadFromExternalPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
           ...
           // String pdfDownloadUrl = "http://182.74.36.11:8080/uat/healingtree/assets/files/hello_health_package/health_checkup_brochure.pdf";
            String pdfDownloadUrl = "http://202.129.240.238/healingtree/assets/files/health_checkup_brochure.pdf";
