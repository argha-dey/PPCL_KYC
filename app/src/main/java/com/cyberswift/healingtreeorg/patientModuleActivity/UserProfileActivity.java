...
import com.cyberswift.healingtreeorg.model.UserDetailsModel;
...
public class UserProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseActivity.checkedMenuItem = BaseActivity.navView.getMenu().findItem(Constants.PROFILE_NAV_ID);
    ...
    public  void  onUserProfileEdit(View view){
    ...
    public void onCancelUserProfileClick(View view){
        finish();
    }
